(function () {
    ...
    function AddPageController(UserService, CourseService, PageService, $location, $routeParams) {
        var viewModel = this;
        ...
        function add(page) {
        	if (page == undefined) {
            	...
            	var promise = PageService.createPage(viewModel.course.courseId, page);
